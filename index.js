...
async function compiledEspacoRecenteBlock(stChatId) {
    ...
    // Match exato primeiro; se não achar (chatId do ST mudou de alguma
    // forma entre quando o vínculo foi salvo e agora, ou o vínculo nunca
    // rolou), cai pra conversa mais recentemente mexida — igual
    // resolverEspacoChatAtivo já faz pro painel. Sem isso aqui, um
    // descompasso silencioso fazia o bloco inteiro sumir sem aviso nenhum.
