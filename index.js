...
async function sendEspacoMessage() {
    ...
    const isMainGenerating = isRpGenerating();
    if (isMainGenerating) {
        if (espacoInput) espacoInput.value = '';
        showAxisFatalError('A IA esta ocupada gerando resposta no chat do RP. Aguarde e tente novamente.');
        return;
    }
