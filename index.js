...
async function respondEspaco(userMessage, chatId) {
    ...
    const systemPrompt =
        ...
        'ponto.\n\n' +
        'Se for pra durar além dessa conversa (a janela de conversa recente é limitada, some com o tempo), duas ' +
        ...
        'inclua o que quer manter, não é lista incremental). Entra INTEIRO em toda fala do RP, garantido — é pra ' +
        'isso que existe, use sem hesitar quando o pedido for desse tipo.\n' +
        '- Fato/lore que se busca por assunto ("o que ela sente pelo X", "como é a cidade") — artefato_escrever ' +
        'normal, chame artefato_ler antes se já existir um sobre o mesmo assunto.\n' +
        'Escrever já é suficiente — sem "vou ficar de olho"/"reforço depois"; resposta curta confirmando que já vale.\n\n' +
